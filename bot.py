...
ADMIN_ID = 8334124528   # apni Telegram numeric ID
CHANNELS = ["https://t.me/piyush_a2z_tricks", "https://t.me/indiantechnical0m"]
# =========================================
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if await joined_all(context.bot, user.id):
        ...
        await update.message.reply_text(
            "🚫 **Access Denied**\n\n"
            "Bot use karne ke liye sabhi channel join karo 👇",
